 ...
 * Lazy-loaded component that renders the Bandsintown widget
 * Only loaded when user has granted marketing consent
...
/**
 * Bandsintown widget component
 * Loads third-party script and renders widget anchor
 */
export default function BandsintownWidget({ artistId }: BandsintownWidgetProps) {
  useEffect(() => {
